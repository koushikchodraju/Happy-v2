...
try:
    ...
    print("[PrinterAgent] aiohttp not installed. Printer HTTP features disabled.")
...
try:
    ...
    # Stub classes so the rest of the file doesn't crash at class definition time
    ...
    class ServiceBrowser:
        pass
    print("[PrinterAgent] zeroconf not installed. Printer discovery disabled.")
